...
export function applyWebRuntimeConfig(wasmPath, proxy) {
 ...
 */
export function applySingleThreadRuntime() {
    ort.env.wasm.simd = true;
    ort.env.wasm.numThreads = 1;
}
export function applyRuntimeThreads(numThreads = 0) {
    if (!numThreads) {
        const threadsAvailable = typeof navigator !== "undefined" ? (navigator.hardwareConcurrency ?? 1) : 1;
